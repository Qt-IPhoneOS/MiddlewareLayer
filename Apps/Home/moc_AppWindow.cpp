...
#include "../../../Apps/Home/AppWindow/AppWindow.h"
...
static constexpr auto qt_meta_stringdata_CLASSAppWindowENDCLASS = QtMocHelpers::stringData(
    "AppWindow"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAppWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAppWindowENDCLASS_t qt_meta_stringdata_CLASSAppWindowENDCLASS = {
    {
