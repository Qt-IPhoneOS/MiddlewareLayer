...
#include "../../../Apps/Home/Model/AppModel.h"
...
static constexpr auto qt_meta_stringdata_CLASSAppModelENDCLASS = QtMocHelpers::stringData(
    "AppModel"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAppModelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAppModelENDCLASS_t qt_meta_stringdata_CLASSAppModelENDCLASS = {
    {
